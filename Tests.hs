...
dic_test = [
	...
	"On July 2nd, communications systems worldwide are sent into chaos by strange atmospheric interference."
	...
	, "On July 3rd, the aliens obliterate New York, Los Angeles, Washington, Paris, London, Houston and Moscow."
